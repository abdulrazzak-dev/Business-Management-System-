    ...
    public OmniSearchResponse search(Authentication authentication, String query) {
        ...
        List<OmniSearchResponse.SearchResultItem> productItems = matchedProducts.stream()
                .map(p -> OmniSearchResponse.SearchResultItem.builder()
                        ...
                        .details("Rs. " + p.getPrice() + " (Stock: " + p.getStockQuantity() + ")")
                        .badge("Products")
                        .url("products.html")
                        .build())
                .collect(Collectors.toList());
        ...
        List<OmniSearchResponse.SearchResultItem> inventoryItems = matchedProducts.stream()
                .map(p -> OmniSearchResponse.SearchResultItem.builder()
                        ...
                        .details("Stock: " + p.getStockQuantity() + " units (" + (p.getStatus() != null ? p.getStatus().name() : "OK") + ")")
                        .badge("Inventory")
                        .url("inventory.html")
                        .build())
                .collect(Collectors.toList());
        ...
        List<OmniSearchResponse.SearchResultItem> orderItems = matchedOrders.stream()
                .map(o -> OmniSearchResponse.SearchResultItem.builder()
                        ...
                        .subtitle("Customer: " + (o.getCustomerName() != null ? o.getCustomerName() : "Walk-in"))
                        .details("Total: Rs. " + o.getTotalAmount() + " | Status: " + o.getStatus())
                        .badge("Orders")
                        .url("orders.html")
                        .build())
                .collect(Collectors.toList());
        ...
        List<OmniSearchResponse.SearchResultItem> customerItems = matchedCustomers.stream()
                .map(c -> OmniSearchResponse.SearchResultItem.builder()
                        .id(c.getId())
                        .title(c.getName())
                        .subtitle("Email: " + c.getEmail())
                        .details("Phone: " + c.getPhone() + " | Orders: " + (c.getOrdersCount() != null ? c.getOrdersCount() : 0))
                        .badge("Customers")
                        .url("customers.html")
                        .build())
                .collect(Collectors.toList());
        ...
        List<OmniSearchResponse.SearchResultItem> activityItems = matchedOrders.stream()
                .map(o -> OmniSearchResponse.SearchResultItem.builder()
                        ...
                        .details("Processed for " + (o.getCustomerName() != null ? o.getCustomerName() : "Customer"))
                        .badge("Activity")
                        .url("dashboard.html")
                        .build())
                .collect(Collectors.toList());
